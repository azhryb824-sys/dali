  ...
  return <PublicPageShell>
    ...
    <section className="inner-content prose-content">
      ...
      <div className="inner-card-grid">
        <article><span>01</span><h3>قريبون منك</h3><p>حضور محلي في حي الرصيفة وفهم لطبيعة الأعمال في مكة.</p></article>
      ...
      <h2>من قلب مكة المكرمة</h2>
      <p>يقع مقرنا في {content.site.address}، ونخدم المنشآت والمشروعات ومواقع العمل في مكة وفق نطاق الخدمة والجاهزية المتاحة.</p>
    </section>
  </PublicPageShell>;
}
