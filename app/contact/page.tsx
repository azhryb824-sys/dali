...
export const metadata: Metadata = { title: "التواصل وطلب عرض سعر", description: "اطلب عرض سعر لتوفير القوى العاملة أو خدمات التشغيل والصيانة في مكة، أو تحدث مباشرة مع فريق شركة دالي.", alternates: { canonical: "/contact" } };

export default function ContactPage() {
  return <PublicPageShell>
    <section className="inner-hero contact-inner-hero"><p className="eyebrow light"><span/>تواصل معنا</p><h1>حدّثنا عن احتياجك،<br/><em>ودعنا نقترح الحل الأنسب.</em></h1><p>سواء كنت تبحث عن قوى عاملة، أو فريق فني، أو خدمات تشغيل وصيانة في مكة، فريق دالي جاهز للاستماع إليك.</p></section>
