...
export default function Home() {
  ...
  return <main>
    ...
    {content.visibility.locations && <section className="local-section"><Image src="/images/dali-mecca.webp" alt="مبانٍ وبنية تحتية حديثة في تضاريس منطقة مكة المكرمة دون كائنات حية" width={1692} height={930} sizes="(max-width: 900px) 100vw, 50vw"/><div className="local-copy"><p className="eyebrow light"><span/> حضور محلي في {content.site.city}</p><h2>{content.home.localTitle}</h2><p>{content.home.localDescription}</p><ul><li>توفير عمالة للشركات والمشروعات في مكة</li><li>فرق تشغيل وصيانة وخدمات مساندة</li><li>فنيون وفرق متعددة المهن</li><li>جاهزية تشغيلية للاحتياج الموسمي والحج</li></ul><Link href="/locations/makkah" className="btn primary">خدماتنا في مكة <Arrow/></Link></div></section>}
