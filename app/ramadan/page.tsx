...
export default async function RamadanPage() {
  ...
  return <PublicPageShell><StructuredData data={data}/>
    <section className="inner-hero hajj-inner-hero"><nav className="page-breadcrumbs" aria-label="مسار الصفحة"><Link href="/">الرئيسية</Link><span>/</span><Link href="/seasons">رمضان والحج</Link><span>/</span><span>رمضان</span></nav><p className="eyebrow light"><span/>موسم رمضان</p><h1>فرق جاهزة،<br/><em>لإيقاع رمضان المتغيّر.</em></h1><p>نساعد المنشآت على تغطية امتداد ساعات العمل وذروة المساء والعشر الأواخر بفرق تشغيلية وفنية وخدمات مساندة وفق احتياج كل مدينة وموقع.</p></section>
    <section className="inner-content"><div className="inner-heading"><p className="eyebrow"><span/>خطة رمضان</p><h2>تغطية تبدأ قبل الذروة</h2><p>نحوّل توقعات الإشغال وحجم الخدمة إلى أعداد وورديات ومواقع، مع فصل احتياج بداية الشهر عن العشر الأواخر بدل الاعتماد على رقم واحد طوال الموسم.</p></div>
