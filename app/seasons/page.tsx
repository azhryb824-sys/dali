...
export default async function SeasonsPage() {
  ...
  return <PublicPageShell><StructuredData data={data}/>
    <section className="inner-hero hajj-inner-hero"><nav className="page-breadcrumbs" aria-label="مسار الصفحة"><Link href="/">الرئيسية</Link><span>/</span><span>رمضان والحج</span></nav><p className="eyebrow light"><span/>التشغيل الموسمي</p><h1>استعداد مبكر،<br/><em>لرمضان والحج.</em></h1><p>موسمان مختلفان في طبيعة التشغيل والاحتياج؛ نبني لكل واحد منهما خطة قوى عاملة وورديات وبدائل تناسب المواقع وفترات الذروة.</p></section>
    <section className="inner-content"><div className="inner-heading"><p className="eyebrow"><span/>اختر الموسم</p><h2>حل موسمي لا يخلط بين احتياجين مختلفين</h2><p>في رمضان تتغير ساعات التشغيل وتتصاعد الحاجة مساءً وفي العشر الأواخر، بينما يتطلب الحج تعبئة مركزة وتوزيعًا دقيقًا على مواقع وفترات محددة.</p></div>
