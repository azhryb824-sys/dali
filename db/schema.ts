...
export const workforceRequests = pgTable(
  "workforce_requests",
  {
    ...
    quotationItemsJson: text("quotation_items_json"),
    quotationTermsJson: text("quotation_terms_json"),
...
export const visitorConversations = pgTable(
  "visitor_conversations",
  {
    ...
    employeeRating: integer("employee_rating"),
...
export const workers = pgTable(
  "workers",
  {
    ...
    iqamaExpiry: text("iqama_expiry"),
    medicalInsuranceExpiry: text("medical_insurance_expiry"),
...
export const contractWorkerAbsences = pgTable(
  "contract_worker_absences",
  {
    ...
    chargeableDays: integer("chargeable_days").notNull().default(1),
