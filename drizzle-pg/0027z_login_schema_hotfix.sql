-- Must sort before the independent HR migration so authentication can recover
-- even when a later module migration is degraded.
...
INSERT INTO private.__dali_migrations (name) VALUES ('0027z_login_schema_hotfix.sql') ON CONFLICT (name) DO NOTHING;
