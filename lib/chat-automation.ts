...
export const defaultChatAutomation: ChatAutomationConfig = {
  ...
  rules: [
    ...
    { id: "ramadan", label: "موسم رمضان", enabled: true, keywords: ["رمضان", "موسم رمضان", "العشر الأواخر", "عمرة رمضان", "إفطار", "سحور"], response: "للاستعداد لموسم رمضان، شاركنا المدينة والمواقع وفترات الذروة والورديات والمهن والأعداد وموعد بدء التعبئة. نراجع معك احتياج الشهر كاملًا والعشر الأواخر بصورة مستقلة حتى تكون الخطة أدق." },
    { id: "hajj", label: "موسم الحج", enabled: true, keywords: ["الحج", "موسم الحج", "المشاعر", "منى", "عرفات", "مزدلفة"], response: "لدعم احتياج موسم الحج في مكة، شاركنا المواقع والفترات والورديات والمهن والأعداد المتوقعة. سيبحث الفريق معك الحل الأنسب بحسب نطاق الخدمة والجاهزية المتاحة." },
