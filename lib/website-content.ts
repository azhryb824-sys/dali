...
export const DEFAULT_WEBSITE_CONTENT: WebsiteContent = {
  ...
  site: {
    ...
    tagline: "قوى عاملة وحلول تشغيل وصيانة تثق بها في مكة",
    description: "شركة سعودية تقدم للشركات والمنشآت في مكة حلولاً مرنة لتوفير القوى العاملة والفرق الفنية وخدمات التشغيل والصيانة، بجاهزية تواكب احتياجات الأعمال والمواسم.",
    city: "مكة المكرمة",
    district: "حي الرصيفة",
  ...
  seo: {
    homeTitle: "شركة دالي للتشغيل والصيانة | توفير عمالة في مكة",
    homeDescription: "شركة دالي للتشغيل والصيانة في حي الرصيفة بمكة: توفير عمالة وفنيين وفرق تشغيل وصيانة للمشروعات والمنشآت مع جاهزية لموسم الحج.",
    organizationDescription: "شركة سعودية في مكة المكرمة تقدم حلول توفير العمالة والكوادر الفنية وفرق التشغيل والصيانة للمشروعات والمنشآت.",
    focusKeywords: "توفير عمالة مكة، شركة تشغيل وصيانة مكة، توريد عمالة مكة، عمالة للشركات في مكة، فنيين صيانة مكة، عمالة موسم الحج مكة",
  },
  home: {
    heroKicker: "حلول موثوقة لأعمالك في مكة المكرمة",
    heroTitle: "الكوادر المناسبة،",
    heroAccent: "في الوقت الذي تحتاجها.",
    heroDescription: "نساعد منشأتك على مواصلة أعمالها بثقة عبر قوى عاملة مؤهلة وفرق فنية وخدمات تشغيل وصيانة مصممة لاحتياجك، مع حضور محلي في مكة وجاهزية خاصة لموسم الحج.",
    aboutTitle: "شريك محلي يضع نجاح أعمالك أولاً.",
    aboutDescription: "من فهم احتياجك إلى انطلاق الفريق في موقع العمل، نقدم تجربة واضحة ومرنة يقودها مختصون يعرفون طبيعة التشغيل في مكة ومتطلبات القطاعات المختلفة.",
