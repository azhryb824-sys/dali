...
const sectors: ManagedEntry[] = [
  ...
  },
  {
    ...
    body: "يختص هذا المسار بتوفير القوى العاملة والفرق الفنية للمشروعات. أما عقود التنفيذ المتكاملة فتُدار بصورة مستقلة من خلال قسم المقاولات وإدارة المشروعات في دالي.",
...
export const DEFAULT_WEBSITE_CONTENT: WebsiteContent = {
  ...
  home: {
    ...
    professions: ["عمال تشغيل", "كهربائيون", "سباكون", "نجارون", "حدادون", "لحامون", "فنيو تكييف", "فنيو صيانة", "مشغلو معدات", "سائقو معدات", "مشرفو مواقع"],
    process: [
...
function upgradeLegacyMarketingCopy(content: WebsiteContent) {
  ...
  const replacements: Array<[keyof WebsiteContent["home"], string, string]> = [
    ...
    ["localTitle", "قريبون من أعمالك، وأسرع في خدمتك.", DEFAULT_WEBSITE_CONTENT.home.localTitle],
    ["localDescription", "من مقرنا في حي الرصيفة بمكة المكرمة، نخدم المنشآت والمشروعات بفهم محلي لاحتياجات المدينة ومواسم الذروة والحج.", DEFAULT_WEBSITE_CONTENT.home.localDescription],
  ...
  const legacyEntryCopy = new Map<string, string>([
    ...
    ["كوادر مهنية وفنية تدعم شركات المقاولات والمشروعات الإنشائية في مكة وفق المرحلة والبرنامج والورديات، دون أن تقدم دالي أعمال المقاولات نفسها.", "كوادر مهنية وفنية تدعم شركات المقاولات والمشروعات الإنشائية وفق المرحلة والبرنامج والورديات، كخدمة مستقلة عن عقود التنفيذ التي يديرها قسم المقاولات في دالي."],
    ...
    ["تتغير احتياجات المشروع من التجهيز إلى التنفيذ والتشطيب. نوفر لشركات المقاولات والجهات المشغلة كوادر تناسب كل مرحلة، مع مرونة تساعدك على مواكبة البرنامج وتقليل أثر النقص المفاجئ. شركة دالي للتشغيل والصيانة مزود قوى عاملة وليست شركة مقاولات.", "تتغير احتياجات المشروع من التجهيز إلى التنفيذ والتشطيب. نوفر لشركات المقاولات والجهات المشغلة كوادر تناسب كل مرحلة، مع مرونة تساعدك على مواكبة البرنامج وتقليل أثر النقص المفاجئ. وإذا كان احتياجك عقد تنفيذ متكاملًا فيمكن تحويله مباشرة إلى قسم المقاولات وإدارة المشروعات."],
    ["شركة دالي ليست شركة مقاولات؛ ويقتصر هذا النطاق على توفير القوى العاملة والفرق الفنية للمشروعات وفق العقد والمتطلبات النظامية السارية.", "يختص هذا المسار بتوفير القوى العاملة والفرق الفنية للمشروعات. أما عقود التنفيذ المتكاملة فتُدار بصورة مستقلة من خلال قسم المقاولات وإدارة المشروعات في دالي."],
