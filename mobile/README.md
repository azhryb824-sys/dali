...
إصدار Android الحالي هو `1.0.2` (`versionCode 3`) باسم **نظام دالي الإداري** ومعرّف الحزمة `sa.dally.mobile`. يستهدف البوابة الرسمية `https://www.dally.info/portal` فقط، ويُثبت كتحديث فوق الإصدار السابق مع بقاء بيانات التطبيق.
