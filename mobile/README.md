...
إصدار Android الحالي هو `1.0.2` (`versionCode 3`) باسم **نظام دالي الإداري** ومعرّف الحزمة `sa.dally.mobile`. يستهدف البوابة الرسمية `https://www.dally.info/portal` فقط، ويتطلب Android System WebView 111 أو أحدث وفق حد المتصفح الذي تتطلبه واجهة Next.js 16.
