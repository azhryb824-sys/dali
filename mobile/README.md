...
إصدار Android الحالي هو `1.0.1` (`versionCode 2`) باسم **نظام دالي الإداري** ومعرّف الحزمة `sa.dally.mobile`. يستهدف البوابة الرسمية `https://www.dally.info/portal` فقط.
