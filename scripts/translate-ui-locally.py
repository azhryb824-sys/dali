...
MANUAL_EN = {
    ...
    "تم اعتماد العقد {{0}} ونسخ رابط رفع النسخة الموقعة إلى الحافظة: {{1}}": "Contract {{0}} was approved, and the signed-copy upload link was copied to the clipboard: {{1}}",
    "تم اعتماد العقد ونسخ رابط رفع النسخة الموقعة إلى الحافظة: {{0}}": "The contract was approved, and the signed-copy upload link was copied to the clipboard: {{0}}",
    "تم اعتماد العقد {{0}}. رابط رفع النسخة الموقعة: {{1}}": "Contract {{0}} was approved. Signed-copy upload link: {{1}}",
    "تم اعتماد العقد. رابط رفع النسخة الموقعة: {{0}}": "The contract was approved. Signed-copy upload link: {{0}}",
...
MANUAL_BN = {
    ...
    "تم اعتماد العقد {{0}} ونسخ رابط رفع النسخة الموقعة إلى الحافظة: {{1}}": "চুক্তি {{0}} অনুমোদিত হয়েছে এবং স্বাক্ষরিত কপি আপলোডের লিংক ক্লিপবোর্ডে কপি করা হয়েছে: {{1}}",
    "تم اعتماد العقد ونسخ رابط رفع النسخة الموقعة إلى الحافظة: {{0}}": "চুক্তি অনুমোদিত হয়েছে এবং স্বাক্ষরিত কপি আপলোডের লিংক ক্লিপবোর্ডে কপি করা হয়েছে: {{0}}",
    "تم اعتماد العقد {{0}}. رابط رفع النسخة الموقعة: {{1}}": "চুক্তি {{0}} অনুমোদিত হয়েছে। স্বাক্ষরিত কপি আপলোডের লিংক: {{1}}",
    "تم اعتماد العقد. رابط رفع النسخة الموقعة: {{0}}": "চুক্তি অনুমোদিত হয়েছে। স্বাক্ষরিত কপি আপলোডের লিংক: {{0}}",
