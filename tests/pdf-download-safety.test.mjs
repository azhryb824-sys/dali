...
test("every generated PDF download uses hardened attachment headers", async () => {
  const [headers, brand, reports, construction, portalDocuments, clientDocuments] = await Promise.all([
  ...
  for (const route of [brand, reports, construction, portalDocuments, clientDocuments]) {
